          ...
          <div v-for="(plan, index) in plans" :key="plan.id" class="plan-card" :class="index % 2 === 0 ? 'plan-theme-light' : 'plan-theme-dark'">
            <div class="plan-header">
              <div class="plan-badge">
                ...
                <span class="badge-text">PLAN {{ String.fromCharCode(65 + index) }} - {{ plan.plan_type_name }}</span>
              </div>
            ...
            <button class="plan-btn" :class="index % 2 === 0 ? 'btn-theme-light' : 'btn-theme-dark'" @click="$router.push('/contact')"> 문의하기 <span>→</span></button>
          </div>
        </div>
